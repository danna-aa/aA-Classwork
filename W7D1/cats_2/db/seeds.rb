...
danna = User.create!(user_name: 'danna', password_digest: '123456', session_token: '654321')
phil = User.create!(user_name: 'phil', password_digest: 'asdfasdf', session_token: 'fdsafdsa')